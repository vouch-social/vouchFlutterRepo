...
class VouchContainer extends StatefulWidget {
  const VouchContainer({super.key});

  @override
  State<VouchContainer> createState() => _VouchContainerState();
}

class _VouchContainerState extends State<VouchContainer> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Center(child: vouchWidget(context)),
      ),
    );
  }
}

Widget vouchWidget(context) {
  return Container(
