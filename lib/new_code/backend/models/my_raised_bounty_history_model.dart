...
//
//     final myBountyHistoryModel = myBountyHistoryModelFromJson(jsonString);
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    myBountyListData: List<SingleBountyData>.from(json["myBountyListData"].map((x) => SingleBountyData.fromJson(x))),
  );
